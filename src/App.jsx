...
>
  <div className="grid md:grid-cols-2 gap-12 items-center w-full">
    ...
    <div className="flex justify-center">
      ...
      <section className="px-10 py-16 bg-white dark:bg-gray-800">
        <center><p className="text-sm font-bold text-blue-600 mb-4">Deployed By Hanifa 🚀</p>
        </center>
        {/* <ol className="list-decimal ml-6 space-y-2">
          <li>Push your project to GitHub</li>
          <li>Go to vercel.com and login</li>
